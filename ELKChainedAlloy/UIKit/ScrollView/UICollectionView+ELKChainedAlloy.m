...
/**
 set frame
 */
- (UICollectionView * _Nonnull (^)(CGRect))elk_setFrame
{
    return ^(CGRect frame) {
        [self setFrame:frame];
        return self;
...
- (UICollectionView * _Nonnull (^)(CGFloat, CGFloat, CGFloat, CGFloat))elk_setFrameMake
{
 ...
 */
- (UICollectionView * _Nonnull (^)(UIColor * _Nonnull))elk_setBackgroundColor
{
